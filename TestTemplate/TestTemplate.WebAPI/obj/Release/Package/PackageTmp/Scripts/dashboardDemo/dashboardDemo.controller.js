...
(function () {
    ...
    angular.module('erp.dashboardDemo').controller('DashboardDemoCtrl', DashboardDemoCtrl);

    DashboardDemoCtrl.$inject = ['$q', '$scope', '$http', 'config', 'tenant', 'authService', '$stateParams', 'kendoGridService', '$window'];

    function DashboardDemoCtrl($q, $scope, $http, config, tenant, authService, $stateParams, kendoGridService, $window) {
        ...
        var subscriptionSiteMap = _.find(authService.currentUser.siteMap, { 'code': 'dashboardDemo-28' });
        ...
        $scope.Refresh = function () {
            ...
            var radio = String($('input[name="State"]:checked').val()).trim();
            console.log("radio", radio);
            // alert(radio);
            var select_WorkCenter = String($('#select_WorkCenter option:selected').text()).trim();

            var select_McID = String($('#select_McID option:selected').text()).trim();

            var select_CustomerList = String($('#select_CustomerList option:selected').text()).trim();

            var select_FGDimension = String($('#select_FGDimension option:selected').text()).trim();
            var select_WOID = String($('#select_WOID option:selected').text()).trim();
            var select_PartID = String($('#select_PartID option:selected').text()).trim();
            var select_PartNO = String($('#select_PartNO option:selected').text()).trim();
            var select_SONO = String($('#select_SONO option:selected').text()).trim();
            var select_Remark = String($('#select_Remark option:selected').text()).trim();
            //  alert(select_Remark);
            // var test = document.getElementById("startDate");
            // var remark1 = $('#select_Fai option:selected').text();

            var startDate = String($('#startDate').find("input").val()).trim();
            var endDate = String($('#endDate').find("input").val()).trim();

            console.log("Date", startDate + " " + endDate);
            console.log("select_WOID", select_WOID);




            if (select_WOID != "") {
                //spGenerateDynamicWOStatusListStatement_wolist
                $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic1',
                            {
                                "radio": "",
                                "WorkCenter": "",
                                "McID": "",
                    ...
                    console.log("spGenerateDynamic1", response);
            ...
            } else if (select_PartNO != "") {
                // spGenerateDynamicWOStatusListStatement_pono
                var promiseArray = [];
                promiseArray.push(
                    $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic11',
                    {
                        "radio": radio,
                ...
                $q.all(promiseArray).then(function (response) {
                    console.log("spGenerateDynamic11", response);
                ...
                if (radio == "Not Completed") {
                    //spGenerateDynamicWOStatusListStatement_solinenootcomplete
                    var promiseArray = [];
                    promiseArray.push(
                        $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic10',
                        {
                            "radio": radio,
                            "WorkCenter": select_WorkCenter,
                            "McID": select_McID,
                    ...
                    $q.all(promiseArray).then(function (response) {
                        console.log("spGenerateDynamic10", response);
                        if (response.length != 0 && response[0].data.success) {
                            makeTable(response[0].data.result);
                        } else {
                            alert("No Work Order found with the current selected parameters");
                    ...
                    //spGenerateDynamicWOStatusListStatement_solinenocomplete
                    var promiseArray = [];
                    promiseArray.push(
                        $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic9',
                        {
                            "radio": radio,
                            "WorkCenter": select_WorkCenter,
                            "McID": select_McID,
                    ...
                    $q.all(promiseArray).then(function (response) {
                        console.log("spGenerateDynamic9", response);
                        if (response.length != 0 && response[0].data.success) {
                            makeTable(response[0].data.result);
                        } else {
                            alert("No Work Order found with the current selected parameters");
                    ...
                    //spGenerateDynamicWOStatusListStatement_solineno
                    var promiseArray = [];
                    promiseArray.push(
                        $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic8',
                        {
                            "radio": radio,
                            "WorkCenter": select_WorkCenter,
                            "McID": select_McID,
                    ...
                    $q.all(promiseArray).then(function (response) {
                        console.log("spGenerateDynamic8", response);
                        if (response.length != 0 && response[0].data.success) {
                            makeTable(response[0].data.result);
                        } else {
                            alert("No Work Order found with the current selected parameters");
            ...
            } else if (select_Remark != "") {
                if (radio == "Not Completed") {
                    //spGenerateDynamicWOStatusListStatement_soremarknotcomplete
                    var promiseArray = [];
                    promiseArray.push(
                        $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic7',
                        {
                            "radio": radio,
                            "WorkCenter": select_WorkCenter,
                            "McID": select_McID,
                    ...
                    $q.all(promiseArray).then(function (response) {
                        console.log("spGenerateDynamic7", response);
                        if (response.length != 0 && response[0].data.success) {
                            makeTable(response[0].data.result);
                        } else {
                            alert("No Work Order found with the current selected parameters");
                    ...
                    //spGenerateDynamicWOStatusListStatement_soremarkcomplete
                    var promiseArray = [];
                    promiseArray.push(
                        $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic6',
                        {
                            "radio": radio,
                            "WorkCenter": select_WorkCenter,
                            "McID": select_McID,
                    ...
                    $q.all(promiseArray).then(function (response) {
                        console.log("spGenerateDynamic6", response);
                        if (response.length != 0 && response[0].data.success) {
                            makeTable(response[0].data.result);
                        } else {
                            alert("No Work Order found with the current selected parameters");
                    ...
                    //spGenerateDynamicWOStatusListStatement_soremark
                    var promiseArray = [];
                    promiseArray.push(
                        $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic5',
                        {
                            "radio": radio,
                            "WorkCenter": select_WorkCenter,
                            "McID": select_McID,
                    ...
                    $q.all(promiseArray).then(function (response) {
                        console.log("spGenerateDynamic5", response);
                        if (response.length != 0 && response[0].data.success) {
                            makeTable(response[0].data.result);
                        } else {
                            alert("No Work Order found with the current selected parameters");
            ...
            } else if (select_FGDimension != "") {
                if (radio == "Not Completed") {
                    //spGenerateDynamicWOStatusListStatement_fgdimentionnotcomplete
                    var promiseArray = [];
                    promiseArray.push(
                        $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic4',
                        {
                            "radio": radio,
                            "WorkCenter": select_WorkCenter,
                            "McID": select_McID,
                    ...
                    $q.all(promiseArray).then(function (response) {
                        console.log("spGenerateDynamic4", response);
                        if (response.length != 0 && response[0].data.success) {
                            makeTable(response[0].data.result);
                        } else {
                            alert("No Work Order found with the current selected parameters");
                    ...
                    //spGenerateDynamicWOStatusListStatement_fgdimentioncomplete
                    var promiseArray = [];
                    promiseArray.push(
                        $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic3',
                        {
                            "radio": radio,
                            "WorkCenter": select_WorkCenter,
                            "McID": select_McID,
                    ...
                    $q.all(promiseArray).then(function (response) {
                        console.log("spGenerateDynamic3", response);
                        if (response.length != 0 && response[0].data.success) {
                            makeTable(response[0].data.result);
                        } else {
                            alert("No Work Order found with the current selected parameters");
                    ...
                    //spGenerateDynamicWOStatusListStatement_fgdimention
                    var promiseArray = [];
                    promiseArray.push(
                        $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic2',
                        {
                            "radio": radio,
                            "WorkCenter": select_WorkCenter,
                            "McID": select_McID,
                    ...
                    $q.all(promiseArray).then(function (response) {
                        console.log("spGenerateDynamic2", response);
                        if (response.length != 0 && response[0].data.success) {
                            makeTable(response[0].data.result);
                        } else {
                            alert("No Work Order found with the current selected parameters");
                ...
                if (radio == "Not Completed") {
                    //spGenerateDynamicWOStatusListStatement_restnotallcomplete
                    var promiseArray = [];
                    promiseArray.push(
                        $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic14',
                        {
                            "radio": radio,
                            "WorkCenter": select_WorkCenter,
                            "McID": select_McID,
                    ...
                    $q.all(promiseArray).then(function (response) {
                        console.log("spGenerateDynamic14", response);
                        if (response.length != 0 && response[0].data.success) {
                            makeTable(response[0].data.result);
                        } else {
                            alert("No Work Order found with the current selected parameters");
                    ...
                    //spGenerateDynamicWOStatusListStatement_restcomolete
                    var promiseArray = [];
                    promiseArray.push(
                        $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic13',
                        {
                            "radio": radio,
                            "WorkCenter": select_WorkCenter,
                            "McID": select_McID,
                    ...
                    $q.all(promiseArray).then(function (response) {
                        console.log("spGenerateDynamic13", response);
                        if (response.length != 0 && response[0].data.success) {
                            makeTable(response[0].data.result);
                        } else {
                            alert("No Work Order found with the current selected parameters");
                    ...
                    //spGenerateDynamicWOStatusListStatement_rest
                    var promiseArray = [];
                    promiseArray.push(
                        $http.post(config.baseUrlApi + 'HMLVTS/spGenerateDynamic12',
                        {
                            "radio": radio,
                            "WorkCenter": select_WorkCenter,
                            "McID": select_McID,
                    ...
                    $q.all(promiseArray).then(function (response) {
                        console.log("spGenerateDynamic12", response);
                        if (response.length != 0 && response[0].data.success) {
                            makeTable(response[0].data.result);
                        } else {
                            alert("No Work Order found with the current selected parameters");
            ...
            //        )
            //.then(function (response) {
            //    console.log("resulthahaha0", response);
            ...
            //            studentData = response.data.result;
            //            console.log("resulthahaha1", studentData)
            //            //console.log("set", $scope.promises);
            //            if (studentData.length == 0) {
            //                alert("No Work Order found with the current selected parameters");
            //                document.getElementById("table").innerHTML = "";
    ...
    .then(function (response) {
        ...
        function makeTable(data) {
            ...
            $("#table").kendoGrid({
                ...
                //{
                //    field: "releasedDate", title: "Released Date", width: 200
                //},
                //{
                //    field: "requestedDeliveryDate", title: "Requested Delivery Date", width: 200
                //}
                //,
                {
                    field: "committedDeliveryDate", title: "Committed Delivery Date", width: 200
                },
                {
                    field: "startDate", title: "Production Start Time", width: 200
                },
                //{
                ...
                {
                    field: "processCompletedQty", title: "Completed Qty", width: 100
                },
                {
