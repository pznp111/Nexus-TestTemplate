(function () {
    ...
    function myCompanyMasterDataMgmtService($http, config, $q) {
        ...
        return {
            ...
            readAllEntityAttrsByEntityId: readAllEntityAttrsByEntityId,
            readAllConnectionByTenantIdAppId: readAllConnectionByTenantIdAppId,
            readTableNameByDataSourceEntityId: readTableNameByDataSourceEntityId,
        ...
        function readAllEntityAttrsByEntityId(entityId) {
            return $http.get(config.baseUrlApi + 'MasterDataRenderings/ReadAllEntityAttrsByEntityId/' + entityId).then(function (results) {
                return results.data;
            });
        }
        ...
        function readTableNameByDataSourceEntityId(entityId) {
            return $http.get(config.baseUrlApi + 'MasterDataRenderings/ReadTableNameByEntityId/' + entityId).then(function (results) {
                return results.data;
            });
        }
