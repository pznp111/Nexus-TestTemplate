    ...
    angular.module('erp')
        .directive('myTabDirective',
            function myTabDirective() {
                return {
                    templateUrl: 'js/myCompany/mytab.directive.template.html',
                    scope: {
                    ...
                    controller: function (kendoGridService, myCompanyMasterDataMgmtService, notificationService) {
                        ...
                        vm.btnSearch = function () {
                            $('#kendoTabGrid-' + vm.modelId).data('kendoGrid').dataSource.read();
                            $('#kendoTabGrid-' + vm.modelId).data('kendoGrid').refresh();
                        ...
                        function asynLoad(tenantIdParam, currAttrNameParam, currDatasourcemodelParam) {
                            return myCompanyMasterDataMgmtService.readTableNameByDataSourcemodelId(currDatasourcemodelParam)
                                .then(function (results) {
                                    var modelName = results;
                                    var selectAllJson = {
                        ...
                        function initLoad(modelId) {
                            var labelList = [];
                            var labelObj = {};

                            myCompanyMasterDataMgmtService.readTableNameByDataSourcemodelId(modelId)
                                 .then(function (tableNameResults) {
                                     myCompanyMasterDataMgmtService.readPrimaryKeyColumn(vm.tenantId, tableNameResults)
                                       .then(function (primaryKeyResult) {
                                           myCompanyMasterDataMgmtService.readAllmodelAttrsBymodelId(modelId)
                                             .then(function (results) {
                                                 ...
                                                 var gridSettings = {
                                                     ...
                                                     endPoints: {
                                                         ...
                                                         create: function (options) {
                                                             var paramJson = { keyId: modelId, tenantId: vm.tenantId };
                                                             $.each(options.data,
                                                                 function (key, value) {
                                                             ...
                                                             myCompanyMasterDataMgmtService.insertExecuteDyanmicQuery(paramJson)
                                                                 .then(function (results) {
                                                                     ...
                                                                     $("#kendoTabGrid-" + modelId).data('kendoGrid').dataSource.read();
                                                                     $("#kendoTabGrid-" + modelId).data('kendoGrid').refresh();
                                                         ...
                                                         destroy: function (options) {
                                                             var paramJson =
                                                                 { keyId: modelId, tenantId: vm.tenantId };
                                                             $.each(options.data,
                                                                 function (key, value) {
                                                                     if (key === primaryKeyResult) {
                                                                         var objPrimary = {};
                                                 ...
                                                 for (var i = 0; i < results.length; i++) {
                                                     ...
                                                     if (results[i].dataSourcemodel != null &&
                                                         results[i].dataSourcemodel !== '00000000-0000-0000-0000-000000000000' &&
                                                 ...
                                                 for (var x = 0; x < results.length; x++) {
                                                     ...
                                                     if (results[x].type === 'datasource') {
                                                         ...
                                                         asynLoad(vm.tenantId, results[x].name, results[x].dataSourcemodel)
